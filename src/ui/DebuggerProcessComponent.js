...
export default class DebuggerProcessComponent extends React.PureComponent<Props, State> {
        ...
        <div className="debugger-thread-filter-row">
          ...
          <ButtonGroup className="inline-block">
            <Button
              ...
              onClick={() => {
                featureConfig.set(SHOW_PAUSED_ONLY_KEY, !this.state.showPausedThreadsOnly)
