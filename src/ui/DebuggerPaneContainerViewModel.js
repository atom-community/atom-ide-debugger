import { DEBUGGER_PANELS_DEFAULT_WIDTH_PX, DEBUGGER_PANELS_DEFAULT_LOCATION } from "../constants"
import DebuggerPaneViewModel from "./DebuggerPaneViewModel"
import invariant from "assert"
import * as React from "react"
import TabBarView from "@atom-ide-community/nuclide-commons-ui/VendorLib/atom-tabs/lib/tab-bar-view"
import UniversalDisposable from "@atom-ide-community/nuclide-commons/UniversalDisposable"
import { View } from "@atom-ide-community/nuclide-commons-ui/View"
...
export default class DebuggerPaneContainerViewModel {
    ...
    this._disposables.add(
      () => {
        this._forEachChildPaneItem((item: atom$PaneItem) => {
          invariant(item instanceof DebuggerPaneViewModel || item instanceof DebuggerPaneContainerViewModel)
  ...
  getPreferredWidth(): number {
    return this._preferredWidth == null ? DEBUGGER_PANELS_DEFAULT_WIDTH_PX : this._preferredWidth
  }
  ...
  _forEachChildPaneItem(callback: (item: atom$PaneItem, pane: atom$Pane) => void): void {
    for (const pane of this._container.getPanes()) {
